...
\subsection*{Milyen adatbázist használtam?}
...
\end{itemize}
\subsection*{Milyen API-kat használtam?}
...
\end{figure}
\footnotetext{Forrás: \url{https://www.interserver.net/}}
...
\begin{figure}[H]
    ...
    \label{fig:signalR}
\end{figure}
\footnotetext{Forrás: \url{https://learn.microsoft.com/}}
